			...
			<div class="container-fluid">
				<div class="row">
					 ...
					 <div class="col-sm-2">
    					...
    					<input type="file" id="image_uploads" name="image_uploads" accept=".jpg, .jpeg, .png" style="margin-left : 290%; display:none">
						<button type="submit"  style = "margin-left : 290%; margin-top : 10%;">Publier</button>
					 </div>
				</div>
		</form>
	</nav>
