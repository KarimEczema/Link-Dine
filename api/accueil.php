		...
		<form method="post" action="traitement.php">
			...
			<div class="container-fluid">
				<div class="row">
					 ...
					 <div class="col-sm-2">
						<input type="file" id="image" name="image" accept="image/png, image/jpeg" style = "margin-left : 300% ; margin-top : 90%;">
						<button type="submit"  style = "margin-left : 300%; margin-top : 10%;">Publier</button>
					 </div>
				</div>
		</form>
	</nav>
