        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <label for="image_uploads"><img id="preview"
                                ...
                                width="120" height="100" alt="Appareil photo . png">
                        </label>
                        <input type="file" id="image_uploads" name="image_uploads" accept=".jpg, .jpeg, .png"
                            onchange="previewImage();" style="display:none">
                        <button type="radio" id="publish_button"
            ...
            <input type="date" id="date" name="date" value="2023-06-06" min="2015-01-01" max="2026-12-31"
