                    ...
                    <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                        ...
                        <div class="scroll-page" id="formation">
                            <h5><B>
                                ...
                                <?php echo htmlspecialchars($row['employeur']); ?>
                            </h5>
                            <h6>Type de contrat :
                            ...
                            <h6>
                                <div class="open-btn">
                                    <button class="open-button"
                                        onclick="openForm(<?php echo $row['idemploi'] ?>)"><strong>Description du
                                            poste</strong></button>
                                </div>
                            </h6>
                            ...
                            <h6>Salaire :
                                <?php echo htmlspecialchars($row['salaire']); ?>/an
                            </h6>
                            <h6 style="font-style:italic">(Date de publication :
                                <?php echo htmlspecialchars($row['datepublication']); ?> )
                            </h6>
                        </div>
