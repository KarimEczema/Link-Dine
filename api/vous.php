    ...
    <div class="row">
        ...
        <div class="col-sm-8" style="background-color: red">
            ...
            <div style="background-color: blue; margin:2%">
                <h3>Description de l'utilisateur</h3>
            </div>
        </div>
    </div>
</nav>
...
<nav class="Ajout-formation">
    ...
    <div class="row">
        <div class="col-sm-4" style="background-color : purple">
            ...
            <input type="date" name="Formation-debut" value="2023-06-06" min="1960-01-01" max="2023-12-31"
                style="margin : 15%">
            <br>
            <h5>Date de fin :</h5>
            <input type="date" name="Formation-fin" value="2023-06-06" min="1960-01-01" max="2040-12-31"
                style="margin : 15% ">
        </div>
        <div class="col-sm-8" style="background-color: grey">
            <div style="background-color: grey; margin:2%">
                <h5>Titre de la formation : <input type="text" name="Formation-titre" style="margin : 5%"> </h5>
            </div>
            <div style="background-color: grey; margin:2%">
                <h5 style="margin:2%">Description de la formation : <textarea id="Formation-text" rows="10" cols="50"
                        style="margin: 3%;"></textarea> </h5>
            </div>
        </div>
...
<nav class="Ajout-projet">
    ...
    <div style="background-color: grey; margin:2%">
        <h5>Nom du projet : <input type="text" name="Projet-titre" style="margin : 5%"> </h5>
    </div>
    <div style="background-color: grey; margin:2%">
        <h5 style="margin:2%"> Description du projet : </h5><textarea id="Projet-text" rows="10" cols="50"
            style="margin: 3%;"></textarea>
    </div>
...
<nav class="CV" style="margin-top:2%">
    ...
    <div class="row">
        ...
        <div class="col-sm-7" style="background-color: red">
            ...
            <div style="background-color: blue; margin:2%">
                <h5>Description de l'utilisateur</h5>
            </div>
        </div>
    </div>
    <div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6" style="background-color: red">
            ...
            <div style="background-color: yellow; margin:2%; margin-right : 10%">
                <h6>Description de la formation</h6>
            </div>
        </div>
    </div>
    <div class="row">
